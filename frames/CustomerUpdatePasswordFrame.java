...
public class CustomerUpdatePasswordFrame extends JFrame implements ActionListener
{
	...
	public CustomerUpdatePasswordFrame(User u)
	{
		super("Customer Update Password Segment");
		...
		this.currentPassPF.setBounds(170,100,100,30);
		...
		this.newPassPF.setBounds(170,150,100,30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(command.equals(backBtn.getText()))
		{
			...
			CustomerHomeFrame cdf=new CustomerHomeFrame(this.u);
